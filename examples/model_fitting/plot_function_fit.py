"""
================================
Fitting a function with smallish
================================

Smallish contains a number of tools for fitting functions to
data. This example shows us how to load data into python, fit
a function to our datapoints with smallish, and then plot the
result.
...
# ------------
#
# First, we'll load some data into smallish.
...
# ---------------
#
# With smallish, models are created with the :ref:Model class.
